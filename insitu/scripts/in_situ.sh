...
rm -rf ${INST_WORK_HOME}/simulation/${USER}
rm -rf ${INST_WORK_HOME}/analysis/workflows/*
rm -rf /p/lscrathd/do7/do7
...
cp ${INST_WORK_HOME}/simulation/input/extract.py.${data_placement} ${INST_WORK_HOME}/simulation/input/extract.py
${INST_WORK_HOME}/simulation/generate_dax.py ${INST_WORK_HOME}/simulation/ascent-test.dax
pegasus-em submit a.mpi ${INST_WORK_HOME}/simulation/plan_dax.sh ${INST_WORK_HOME}/simulation/ascent-test.dax
